  ...
  return (
    <section id="hero" className="relative overflow-hidden bg-navy">
      ...
      <div className="absolute inset-0">
        <img src={heroImage} alt="Professional plumber at work" className="w-full h-full object-cover opacity-30" />
        <div className="absolute inset-0 bg-gradient-to-r from-navy via-navy/90 to-navy/60" />
      </div>

      <div className="container relative z-10 py-20 md:py-32 lg:py-40">
        <div className="max-w-2xl space-y-6 animate-fade-in-up">
          <span className="inline-block px-4 py-1.5 rounded-full bg-accent/20 text-gold text-sm font-semibold tracking-wide">
          ...
          <p className="text-lg md:text-xl text-navy-foreground/80 max-w-xl">
            From emergency repairs to full installations, AquaFlow delivers fast, professional plumbing services for homes and businesses across Nairobi and beyond.
          </p>
